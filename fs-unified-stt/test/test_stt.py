...
class STTTester:
    def __init__(self, url: str, wav_file: str, provider: str, lang: str = "en-US"):
        self.url = url
...
Examples:
  ...
  Quick test:      ./test_stt.py --max-duration 30
    ...
    parser.add_argument("--provider", default="google-v2",
                        choices=["google-v2", "google-v1", "aws"],
                        help="STT provider to use (default: google-v2)")
