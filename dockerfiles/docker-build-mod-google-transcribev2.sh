...
echo ""
echo "2. Run with Google Cloud credentials:"
...
echo "     -v \$(pwd)/secrets/google-creds.json:/etc/freeswitch/google-creds.json:ro \\"
echo "     ${IMAGE_TAG}"
echo ""
echo "3. Use docker-compose:"
echo "   # Update dockerfiles/docker-compose-mod-google-transcribev2.yml with your settings"
echo "   docker-compose -f dockerfiles/docker-compose-mod-google-transcribev2.yml up -d"
echo ""
echo "4. Validate the module:"
echo "   ./dockerfiles/validate-mod-google-transcribev2.sh freeswitch-google"
echo ""
echo -e "${BLUE}=============================================${NC}"
