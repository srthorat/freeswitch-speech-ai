...
go build -trimpath -ldflags "-s -w -X main.gitSha=${GIT_SHA} -X main.buildTime=${BUILD_TIME}" -o /tmp/google-speech-v2-build/google-speech-service-v2 ./cmd/google-speech-service-v2 || \
  go build -trimpath -o /tmp/google-speech-v2-build/google-speech-service-v2 ./cmd/google-speech-service-v2
