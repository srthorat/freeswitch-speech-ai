#ifndef __GOOGLE_TRANSCRIBE_GLUE_H__
#define __GOOGLE_TRANSCRIBE_GLUE_H__
...
switch_bool_t google_transcribe_frame(switch_core_session_t *session, switch_media_bug_t *bug);
