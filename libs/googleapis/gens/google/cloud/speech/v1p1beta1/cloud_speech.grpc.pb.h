   ...
   public:
    ...
    class async_interface {
     public:
      ...
      // Performs synchronous speech recognition: receive results after all audio
      // has been sent and processed.
      virtual void Recognize(::grpc::ClientContext* context, const ::google::cloud::speech::v1p1beta1::RecognizeRequest* request, ::google::cloud::speech::v1p1beta1::RecognizeResponse* response, std::function<void(::grpc::Status)>) = 0;
      virtual void Recognize(::grpc::ClientContext* context, const ::google::cloud::speech::v1p1beta1::RecognizeRequest* request, ::google::cloud::speech::v1p1beta1::RecognizeResponse* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      // Performs asynchronous speech recognition: receive results via the
      // google.longrunning.Operations interface. Returns either an
      // `Operation.error` or an `Operation.response` which contains
      // a `LongRunningRecognizeResponse` message.
      // For more information on asynchronous speech recognition, see the
      // [how-to](https://cloud.google.com/speech-to-text/docs/async-recognize).
      virtual void LongRunningRecognize(::grpc::ClientContext* context, const ::google::cloud::speech::v1p1beta1::LongRunningRecognizeRequest* request, ::google::longrunning::Operation* response, std::function<void(::grpc::Status)>) = 0;
      virtual void LongRunningRecognize(::grpc::ClientContext* context, const ::google::cloud::speech::v1p1beta1::LongRunningRecognizeRequest* request, ::google::longrunning::Operation* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      // Performs bidirectional streaming speech recognition: receive results while
      // sending audio. This method is only available via the gRPC API (not REST).
      virtual void StreamingRecognize(::grpc::ClientContext* context, ::grpc::ClientBidiReactor< ::google::cloud::speech::v1p1beta1::StreamingRecognizeRequest,::google::cloud::speech::v1p1beta1::StreamingRecognizeResponse>* reactor) = 0;
    };
  ...
  class Stub final : public StubInterface {
   public:
    ...
    class async final :
     ...
     public:
      void Recognize(::grpc::ClientContext* context, const ::google::cloud::speech::v1p1beta1::RecognizeRequest* request, ::google::cloud::speech::v1p1beta1::RecognizeResponse* response, std::function<void(::grpc::Status)>) override;
      void Recognize(::grpc::ClientContext* context, const ::google::cloud::speech::v1p1beta1::RecognizeRequest* request, ::google::cloud::speech::v1p1beta1::RecognizeResponse* response, ::grpc::ClientUnaryReactor* reactor) override;
      void LongRunningRecognize(::grpc::ClientContext* context, const ::google::cloud::speech::v1p1beta1::LongRunningRecognizeRequest* request, ::google::longrunning::Operation* response, std::function<void(::grpc::Status)>) override;
      void LongRunningRecognize(::grpc::ClientContext* context, const ::google::cloud::speech::v1p1beta1::LongRunningRecognizeRequest* request, ::google::longrunning::Operation* response, ::grpc::ClientUnaryReactor* reactor) override;
      void StreamingRecognize(::grpc::ClientContext* context, ::grpc::ClientBidiReactor< ::google::cloud::speech::v1p1beta1::StreamingRecognizeRequest,::google::cloud::speech::v1p1beta1::StreamingRecognizeResponse>* reactor) override;
     private:
      friend class Stub;
   ...
   public:
    WithCallbackMethod_Recognize() {
      ::grpc::Service::MarkMethodCallback(0,
          new ::grpc::internal::CallbackUnaryHandler< ::google::cloud::speech::v1p1beta1::RecognizeRequest, ::google::cloud::speech::v1p1beta1::RecognizeResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::google::cloud::speech::v1p1beta1::RecognizeRequest* request, ::google::cloud::speech::v1p1beta1::RecognizeResponse* response) { return this->Recognize(context, request, response); }));}
    void SetMessageAllocatorFor_Recognize(
        ::grpc::MessageAllocator< ::google::cloud::speech::v1p1beta1::RecognizeRequest, ::google::cloud::speech::v1p1beta1::RecognizeResponse>* allocator) {
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(0);
      static_cast<::grpc::internal::CallbackUnaryHandler< ::google::cloud::speech::v1p1beta1::RecognizeRequest, ::google::cloud::speech::v1p1beta1::RecognizeResponse>*>(handler)
    ...
    virtual ::grpc::ServerUnaryReactor* Recognize(
      ::grpc::CallbackServerContext* /*context*/, const ::google::cloud::speech::v1p1beta1::RecognizeRequest* /*request*/, ::google::cloud::speech::v1p1beta1::RecognizeResponse* /*response*/)  { return nullptr; }
  };
  template <class BaseClass>
   ...
   public:
    WithCallbackMethod_LongRunningRecognize() {
      ::grpc::Service::MarkMethodCallback(1,
          new ::grpc::internal::CallbackUnaryHandler< ::google::cloud::speech::v1p1beta1::LongRunningRecognizeRequest, ::google::longrunning::Operation>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::google::cloud::speech::v1p1beta1::LongRunningRecognizeRequest* request, ::google::longrunning::Operation* response) { return this->LongRunningRecognize(context, request, response); }));}
    void SetMessageAllocatorFor_LongRunningRecognize(
        ::grpc::MessageAllocator< ::google::cloud::speech::v1p1beta1::LongRunningRecognizeRequest, ::google::longrunning::Operation>* allocator) {
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(1);
      static_cast<::grpc::internal::CallbackUnaryHandler< ::google::cloud::speech::v1p1beta1::LongRunningRecognizeRequest, ::google::longrunning::Operation>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ...
    virtual ::grpc::ServerUnaryReactor* LongRunningRecognize(
      ::grpc::CallbackServerContext* /*context*/, const ::google::cloud::speech::v1p1beta1::LongRunningRecognizeRequest* /*request*/, ::google::longrunning::Operation* /*response*/)  { return nullptr; }
  };
  template <class BaseClass>
   ...
   public:
    WithCallbackMethod_StreamingRecognize() {
      ::grpc::Service::MarkMethodCallback(2,
          new ::grpc::internal::CallbackBidiHandler< ::google::cloud::speech::v1p1beta1::StreamingRecognizeRequest, ::google::cloud::speech::v1p1beta1::StreamingRecognizeResponse>(
            [this](
    ...
    virtual ::grpc::ServerBidiReactor< ::google::cloud::speech::v1p1beta1::StreamingRecognizeRequest, ::google::cloud::speech::v1p1beta1::StreamingRecognizeResponse>* StreamingRecognize(
      ::grpc::CallbackServerContext* /*context*/)
      { return nullptr; }
  };
  typedef WithCallbackMethod_Recognize<WithCallbackMethod_LongRunningRecognize<WithCallbackMethod_StreamingRecognize<Service > > > CallbackService;
    ...
    WithStreamedUnaryMethod_Recognize() {
      ::grpc::Service::MarkMethodStreamed(0,
        new ::grpc::internal::StreamedUnaryHandler<
          ::google::cloud::speech::v1p1beta1::RecognizeRequest, ::google::cloud::speech::v1p1beta1::RecognizeResponse>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerUnaryStreamer<
                     ::google::cloud::speech::v1p1beta1::RecognizeRequest, ::google::cloud::speech::v1p1beta1::RecognizeResponse>* streamer) {
   ...
   public:
    WithStreamedUnaryMethod_LongRunningRecognize() {
      ::grpc::Service::MarkMethodStreamed(1,
        new ::grpc::internal::StreamedUnaryHandler<
          ::google::cloud::speech::v1p1beta1::LongRunningRecognizeRequest, ::google::longrunning::Operation>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerUnaryStreamer<
                     ::google::cloud::speech::v1p1beta1::LongRunningRecognizeRequest, ::google::longrunning::Operation>* streamer) {
